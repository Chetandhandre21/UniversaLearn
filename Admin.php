                    ...
                    <nav class="navbar navbar-expand-lg navbar-light"><a class="navbar-brand" href="index.html"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-mortarboard-fill" viewBox="0 0 16 16">
                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-end"
                            ...
                            <ul class="navbar-nav align-items-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="uploads.php">AddEContents</a>
                                </li>
                                <li class="nav-item">
                ...
                <div class="col-lg-6 col-xl-6">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            <h5>Manage Operations Of UniversaLearn</h5>
        ...
        <div class="container">
            ...
            <div class="col-sm-6 col-xl-3 align-self-center">
                    <div class="single_feature_text ">
                        <h2>Add <br> Courses</h2>
                       
                        <a href="Addcourse.php" class="btn_1">Go</a>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3 align-self-center">
                    <div class="single_feature_text ">
                        <h2>Add<br> E-Contents</h2>
                       
                        <a href="uploads.php" class="btn_1">Go</a>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3 align-self-center">
                    <div class="single_feature_text ">
                        <h2>Users<br> feedback</h2>
                        
                        <a href="feedback.php" class="btn_1">Go</a>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3 align-self-center">
                    <div class="single_feature_text ">
                        <h2>View Courses <br> </h2>
                        
                        <a href="adviewco.php" class="btn_1">Go</a>
                    </div>
                </div>
            </div>
        </div>
